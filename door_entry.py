...
algorithm: 
    A buglary support system tracking customer's faces tracks which direction the customer walks through the door to ensure that everyone enters and exits through the main door during business hours, not before, not after. 
